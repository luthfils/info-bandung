...
$query=mysql_query("delete from t_gambar where id_gambar='$id_gambar'");
if($query){
	$nama_file="../../gambar/info_bandung/gallery/".$gambar;
	unlink($nama_file);
	echo "Data sudah di hapus! </br></br> <a href=view_data.php> <input type='button' class='formstyletwo-warning' value='View Gallery Informasi'></a>";
}
?>
