...
$query = "SELECT * FROM t_info_harga";
...
<body>
	<div class="content-info-harga"">
		...
		<div class="isi">
			<center>
				<a href="index.php">
					<input type="button" class="tombol"  value="Input Info Harga"> 
				</a>
				</br></br></br>
				<div class="border">
					<table align="center" cellspacing="3" cellpadding="3" align="center" border="0" class="display" id="example">
						<thead>
							 <tr>
								<th width="20px">No</th>
								<th width="91px">Id Info Harga</th>
								<th width="82px">Id informasi</th>
								<th width="190px">Nama Judul</th>
								<th>Harga</th>
								<th>Keterangan</th>								
								<th>Aksi</th>
							 </tr>
					  ...
					  <?php do { ?>
						<tr>
							...
							<td><?php echo $row_datatables['id_info_harga']; ?></td>
							<td><?php echo $row_datatables['id_informasi']; ?></td>
							<td><?php echo $row_datatables['nama_judul']; ?></td>
							<td><?php echo $row_datatables['harga']; ?></td>
							<td><?php echo $row_datatables['ket']; ?></td>
							<td id ="edit-links">
								<a href="delete.php?id_info_harga=<?php echo $row_datatables['id_info_harga']; ?>" onClick="return confirm('Apakah Anda yakin akan menghapus data ini?')">Delete</a> |
								<a href="edit.php?id_info_harga=<?php echo $row_datatables['id_info_harga']; ?>">Edit</a>
							</td>		
						</tr>
