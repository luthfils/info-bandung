...
<html>
<head>
	<title>Input Contoh Informasi</title>
						...
						<center>
							<table>
								<tr>
									...
									<td width="30">&nbsp;</td>
									<td width="292"><input type="text" placeholder="Id jenis" class="formstyle-id" title="Id Jenis" name="id_jenis" /></td>
								</tr>
								<tr>
									<td width="125">Nama Contoh</td>
									<td width="30">&nbsp;</td>
									<td width="292"><input type="text" placeholder="Nama contoh" class="formstyle" title="Nama Contoh" name="contoh" /></td>
								</tr>
								<tr>
									<td>Gambar Contoh</td>
									<td>&nbsp;</td>
									<td><input type="file"  class="formstyle" title="Gambar Contoh" name="gambar" /></td>
								</tr>
								<tr>
									<td colspan="3"><p></p></td>
								</tr>
