...
<html>
<head>
	<title>Input Kategori Informasi</title>
	...
	<div class="content">
		<header>
			<div class="judul">
				...
				<center>
					<h3>Input Kategori Informasi</h3>
				</center>
			</div>
		</header>
		<div class="isi">
						...
						<center>
							<table>
								<tr>
									...
									<td width="30">&nbsp;</td>
									<td width="292"><input type="text" placeholder="Nama kategori" class="formstyle" title="Nama Kategori" name="kategori" /></td>
								</tr>
								<tr>
									<td>Gambar Kategori</td>
									<td>&nbsp;</td>
									<td><input type="file"  class="formstyle" title="Gambar Kategori" name="gambar" /></td>
								</tr>
								<tr>
									<td colspan="3"><p></p></td>
								</tr>
