<html>
<head>
	<title>Edit Kategori Informasi</title>
				...
				<div id="formwrap">
					<form  id="submitform" action="update.php" enctype="multipart/form-data" method="post" name="postform">
						...
						<center>
							<table>
								<tr>
									<td width="125">Nama Kategori</td>
									<td width="30">&nbsp;</td>
									<td width="292"><input type="text" class="formstyle" name="kategori" value="<?php echo $kategori; ?>" size="30"/></td>
								</tr>
								<tr>
									<td>Gambar Sebelumnya</td>
									<td>&nbsp;</td>
									<td>
										<img src="../../gambar/info_bandung/gambar_kategori/<?php echo $gambar;?>" id="gambar-sebelumnya" width="100" height="100">
									</td>
								</tr>
								<tr>
									<td></td>
								...
								<tr>
									...
									<td>
										<a href="view_data.php">
											<input type="button" class="formstyletwo"  value="View Kategori Informasi"> 
										</a>
									</td>
								</tr>
							</table>
